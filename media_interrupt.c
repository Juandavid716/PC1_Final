...
extern volatile short color1, color2;
...
int main(void)
{
	...
	VGA_box (0,0,screen_x,screen_y,0);
...
//	VGA_text (INTEL_x1, INTEL_y, text_INTEL);
	while (1)
	{
		...
		if((byte1==9 || byte1==25) && (x1>10 || y1>10)){
		/*vectorcorx[contador] = x2;
		vectorcory[contador] = y2;
		colorcor[contador] = color2;*/
